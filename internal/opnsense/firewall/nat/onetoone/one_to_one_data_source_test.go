		...
		Steps: []resource.TestStep{
			// Read testing (via id)
			{
				...
				ConfigStateChecks: []statecheck.StateCheck{
					statecheck.ExpectKnownValue("data.opnsense_firewall_nat_one_to_one.test_acc_data_source", tfjsonpath.New("enabled"), knownvalue.Bool(true)),
					statecheck.ExpectKnownValue("data.opnsense_firewall_nat_one_to_one.test_acc_data_source", tfjsonpath.New("log"), knownvalue.Bool(true)),
					...
					statecheck.ExpectKnownValue("data.opnsense_firewall_nat_one_to_one.test_acc_data_source", tfjsonpath.New("categories"), knownvalue.ListExact([]knownvalue.Check{
						knownvalue.StringExact("perm_test_acc_category"),
					})),
					statecheck.ExpectKnownValue("data.opnsense_firewall_nat_one_to_one.test_acc_data_source", tfjsonpath.New("description"), knownvalue.StringExact("one-to-one nat rule for terraform data source testing")),
				},
			},
		},
	})
