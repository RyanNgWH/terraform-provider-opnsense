...
func TestAccAliasDataSource_host(t *testing.T) {
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			// Read testing
			{
				Config: acctest.ProviderConfig + testAccAliasHostDataSourceConfig,
...
// testAccAliasDataSourceConfig creates an alias resource and imports it as a data source
const testAccAliasHostDataSourceConfig = `
